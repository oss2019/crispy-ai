...
promise.then(function(stream) {
  ...
  recorder.onstop = function(event) {
    ...
    formData.append('audio_file', blob, "recordings.wav");
    $.ajax({
        type: "POST",
        ...
        success: function(data){
            ...
            // for modifying storage location in Django
            let url_part = data.url.split("/");
            audio.src = url_part[1] + '/audio/' + url_part[2];
        },
